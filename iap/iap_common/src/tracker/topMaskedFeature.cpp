 ...
 */
/** ***************************************************************************
 * TopMaskedFeature Model (implementation)
 ******************************************************************************
 * $Author: dubik $
...
TopMaskedFeature::TopMaskedFeature(float x, float y, bool lost,
...
TopMaskedFeature::~TopMaskedFeature()
{
}
// ============================================================================

FeaturePtr TopMaskedFeature::clone() const
{
    FeaturePtr copy(new TopMaskedFeature(Feature::_x, Feature::_y, Feature::_lost,
                            Feature::_error));
    return copy;
}
// ============================================================================

float TopMaskedFeature::compareTo(std::pair<float, float> pt,
...
bool TopMaskedFeature::isFeature(std::pair<float, float> pt,
               const Image* img, const Image* mask)
{
    int height = mask->getHeight();
    int width = mask->getWidth();
...
void TopMaskedFeature::generateDescriptor(std::pair<float, float> pt,
                             const Image *img, const Image *mask)
{
    int height = mask->getHeight();
    int width = mask->getWidth();
