 ...
 */
#ifndef BOTTOM_MASKED_FEATURE_H
#define BOTTOM_MASKED_FEATURE_H
...
/**
 *\class    BottomMaskedFeature
 *\brief
 *$Author: dubik $
 *$Date: 2009/03/10 15:00:45 $
 *$Revision: 1.1 $
 */
 class BottomMaskedFeature : public Feature{
  public:
  /**
   * BottomMaskedFeature constructor
   *
   ...
   */
    BottomMaskedFeature(float x=0, float y=0, bool isLost=false,
    ...
    /**
     * Creates a new BottomMaskedFeature object with the same values as this one and
