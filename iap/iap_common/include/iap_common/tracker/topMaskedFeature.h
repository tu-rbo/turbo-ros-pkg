 ...
 */
#ifndef TOP_MASKED_FEATURE_H
#define TOP_MASKED_FEATURE_H

#include "feature.h"

namespace vision{
/**
 *\class    TopMaskedFeature
 *\brief
 *$Author: dubik $
 *$Date: 2009/03/10 15:00:54 $
 *$Revision: 1.1 $
 */
 class TopMaskedFeature : public Feature{
  public:
  /**
   * TopMaskedFeature constructor
   *
   ...
   */
    TopMaskedFeature(float x=0, float y=0, bool isLost=false,
                        float error=0.0, float quality = -1.0);


    /**
     * Creates a new TopMaskedFeature object with the same values as this one and
