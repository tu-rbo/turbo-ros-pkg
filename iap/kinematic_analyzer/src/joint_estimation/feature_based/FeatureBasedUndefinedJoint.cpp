 ...
 */
/*
 * FeatureBasedUndefinedJoint.cpp
 *
...
FeatureBasedUndefinedJoint::FeatureBasedUndefinedJoint()
: Joint(), FeatureBasedJoint(), UndefinedJoint()
{
}

FeatureBasedUndefinedJoint::FeatureBasedUndefinedJoint(const FeatureBasedUndefinedJoint& tbpj)
: Joint(tbpj), FeatureBasedJoint(tbpj), UndefinedJoint(tbpj)
{
...
void FeatureBasedUndefinedJoint::estimateAxis()
{
...
double FeatureBasedUndefinedJoint::getGoodnessOfFit()
{
  // TODO
  return -1;
}
...
::iap_common::JointMsg FeatureBasedUndefinedJoint::toROSMsg()
{
