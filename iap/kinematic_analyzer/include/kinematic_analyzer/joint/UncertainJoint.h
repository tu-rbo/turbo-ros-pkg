...
#ifndef UNCERTAINJOINT_H_
#define UNCERTAINJOINT_H_

#include "Joint.h"

class UncertainJoint;
typedef boost::shared_ptr<UncertainJoint> UncertainJointPtr;

class UncertainJoint : virtual public Joint
{
public:
  UncertainJoint();
  UncertainJoint(const UncertainJoint& pj);
  virtual ~UncertainJoint();
...
protected:
  virtual UncertainJoint* doClone() const = 0;
};

#endif /* UNCERTAINJOINT_H_ */
