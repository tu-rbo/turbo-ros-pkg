...
#include "../libs/imagelib/canny.h"
#include "../libs/imagelib/defines.h"
#include "../libs/imagelib/filter.h"
#include "../libs/imagelib/fit.h"
#include "../libs/matrix/matrix.h"
#include "../libs/imagelib/pgm.h"
#include "../libs/imagelib/resample.h"
#include "../libs/imagelib/transform.h"
...
void ImageData::LoadKeysWithScaleRot(bool descriptor, bool undistort) 
{
    ...
    /* Try to find a keypoint file */    
    std::vector<KeypointWithScaleRot> kps;// = ReadKeyFileWithScaleRot(m_key_name, descriptor);
...
img_t *ImageData::UndistortImageResize(int w_new, int h_new)
{
	...
	return 0;//LoadJPEG(undistort_jpg_buf);
    }
